...
<div>
	<div class="goods">
		<div class="menu-wrapper" ref="menuWrapper">
			<ul>
				<li v-for="(item,key) in goods" @click="selectMenu(key,$event)" class="menu-item" :class="{'current':currentIndex===key}">
					<span class="text">
	...
	<shopcart :selectFoods="selectFoods" :deliveryprice="seller.seller.deliveryPrice" :minprice="seller.seller.minPrice" ></shopcart>
